...
public class controlador_compras extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            compras_d=new Compras_detalle(Integer.valueOf(request.getParameter("txt_id_compra_detalle")), Integer.valueOf(request.getParameter("txt_compra")), Integer.valueOf(request.getParameter("drop_producto")), Integer.valueOf(request.getParameter("txt_cantidad")), Double.valueOf(request.getParameter("txt_precio_unitario")));
            compra=new Compras(Integer.valueOf(request.getParameter("txt_compra")), Integer.valueOf(request.getParameter("txt_orden_compra")), Integer.valueOf(request.getParameter("drop_proveedor")), request.getParameter("txt_fecha_orden"));
