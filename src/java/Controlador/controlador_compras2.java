...
public class controlador_compras2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            compras_d= new Compras_detalle(0,Integer.valueOf(request.getParameter("txt_id_compra")), Integer.valueOf(request.getParameter("drop_producto2")), Integer.valueOf(request.getParameter("txt_cantidad2")),Double.valueOf(request.getParameter("txt_precio2")));
