...
'use strict';
const btn_agregar = document.querySelector('#btn_agregar_productos');
const btn_modificar = document.querySelector('#btn_modificar_productos');
let validar = () => {
